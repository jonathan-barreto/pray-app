...
class PrivateDevotionalsPageController extends ChangeNotifier {
  final GetUserDevotionalsUsecase _getUserDevotionalsUsecase;
  ...
  PrivateDevotionalsPageController({
    required GetUserDevotionalsUsecase getUserDevotionalsUsecase,
  }) : _getUserDevotionalsUsecase = getUserDevotionalsUsecase;
  ...
  Future<void> loadDevotionals() async {
    ...
    final result = await _getUserDevotionalsUsecase(currentPage);
